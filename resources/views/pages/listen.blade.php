...
@section('content')
  <div style="margin-top: 94px" class="wrap-profile position-relative">
      ...
      <div id="user-statistic" class="artist_detail wapper pt20">
        ...
        <div class="show-listen mt-5 container pb-5">
            <div class="d-flex justify-content-between align-items-center">
                <div class="title-listen">Bài hát đã nghe</div>
                <div class="play-listen">
                    <a href="#">
            ...
            <div class="pl-5 mt-5">Bạn chưa có bài hát nào</div>
        </div>
      </div>
  </div>
@stop
